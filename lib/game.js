...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let shipImage = new ShipImage(100, 100, "images/swordfish1.png", 250, 450, "image");
  let ship2 = new Ship2(100, 25, "pink", 250, 450, "not-image");
  let ship = new Ship(25, 100, "blue", 250, 400, "not-image");
  ...
  function restartFunc() {
    ...
    // images/swordfish1.png
    ship = new Ship(25, 100, "blue", 250, 400, "not-image");
    ship2 = new Ship2(100, 25, "pink", 212, 452, "not-image");
    spaceJunks = [];
    interval = setInterval(refresh, 20);
    $('.restartMenu').hide();
  }
