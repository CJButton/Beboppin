...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let ship2 = new Ship2(100, 25, "pink", 250, 400, "not-image");
  let ship = new Ship(25, 100, "blue", 287, 355, "not-image");
  ...
  function restartFunc() {
    ...
    // images/swordfish1.png
    shipImage = new ShipImage(100, 100, "images/swordfish1.png", 400, 355, "image");
    ship2 = new Ship2(100, 25, "pink", 400, 400, "not-image");
    ship = new Ship(25, 100, "blue", 437, 355, "not-image");
    spaceJunks = [];
    interval = setInterval(refresh, 20);
    $('.restartMenu').hide();
  }
